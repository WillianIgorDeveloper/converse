    ...
    <div className="overflow-hidden relative">
      <main className="container m-auto">
        <section className="flex flex-col items-center py-5 md:flex-row-reverse md:justify-evenly">
          <img src="/assets/top-wave.svg" alt="Imagem de Background" className="absolute -z-50 top-0 right-0 w-3/4" />
          ...
          <div className="p-5 flex flex-wrap justify-center gap-3 md:gap-8">
            <div className="flex flex-col items-center w-40 h-44 justify-center p-3 gap-2 bg-gray-100 dark:bg-gray-800 shadow rounded text-center hover:scale-110 transition-transform duration-200">
              <div className="flex gap-2 justify-center">
                <img src="/assets/icons/technologies/react.svg" alt="" className="h-12" />
                <img src="/assets/icons/technologies/vite.svg" alt="" className="h-12" />
              </div>
            ...
            <div className="flex flex-col items-center w-40 h-44 justify-center p-3 gap-2 bg-gray-100 dark:bg-gray-800 shadow rounded text-center hover:scale-110 transition-transform duration-200">
              <img src="/assets/icons/technologies/reactrouter.svg" alt="" className="h-12" />
            ...
            <div className="flex flex-col items-center w-40 h-44 justify-center p-3 gap-2 bg-gray-100 dark:bg-gray-800 shadow rounded text-center hover:scale-110 transition-transform duration-200">
              <img src="/assets/icons/technologies/tailwindcss.svg" alt="" className="h-12" />
            ...
            <div className="flex flex-col items-center w-40 h-44 justify-center p-3 gap-2 bg-gray-100 dark:bg-gray-800 shadow rounded text-center hover:scale-110 transition-transform duration-200">
              <img src="/assets/icons/technologies/antdesign.svg" alt="" className="h-12" />
